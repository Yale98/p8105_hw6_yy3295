...
The proposed regression model uses baby's head circumference at birth (centimeters), baby's length at birth (grams), gestational age in weeks as predictors. This is a hypothesized model based on my understanding about genetics.
